...
//        mailService.sendEmail("grochowski.k.1@gmail.com", "testSubject", "testContent", false, false);
//        MimeMessage message = messageCaptor.getValue();
//        assertThat(message.getSubject()).isEqualTo("testSubject");
//        assertThat(message.getAllRecipients()[0].toString()).isEqualTo("grochowski.k.1@gmail.com");
